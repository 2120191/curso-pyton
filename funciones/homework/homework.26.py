...
#1.-actualizaR LOS REGITSROS CON UN CAMPO mas todos tendren el campo de programa de estudio de enfermeria
#2-buscar els egundo registro y actualizar su edad a 50 años
